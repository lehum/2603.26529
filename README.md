...
### `Complex-Bumblebee.nb`

Mathematica notebook containing the symbolic calculations developed in this work, including the evaluation of the Feynman diagrams used in the one-loop renormalization of the complex bumblebee model.

### `COMPLEX-BUMBLEBEE.zip`

Archive containing the corresponding FeynArts model files for the complex bumblebee model.
